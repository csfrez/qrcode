...
public class PsImage {
	...
	public static void main(String[] args) throws Exception{
		File image = new File("D:/test/image/5.jpg");
		PsImage psImage = new PsImage(image);
		
		psImage.reverse(false).createPic(new File("D:/test/image/5_reverse.jpg") );
		//psImage.rotate(60).createPic(new File("D:/test/image/5_60.jpg"));
	}
}
